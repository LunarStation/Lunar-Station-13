GLOBAL_LIST_INIT(loadout_categories, list(
	...
	// LUNAR EDIT: xenowear category
	LOADOUT_CATEGORY_XENOWEAR = list(LOADOUT_SUBCATEGORY_XENOWEAR_TESHARI, LOADOUT_SUBCATEGORY_XENOWEAR_CLOAK_S, LOADOUT_SUBCATEGORY_XENOWEAR_CLOAK_H, LOADOUT_SUBCATEGORY_XENOWEAR_CLOAK_B),
